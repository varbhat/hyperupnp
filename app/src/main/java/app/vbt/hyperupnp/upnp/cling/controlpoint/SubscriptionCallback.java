 ...
 * <p>
 * Usage example, establishing a subscription with a {@link app.vbt.hyperupnp.upnp.cling.model.meta.Service}:
 * </p>
 * <pre>
...
public abstract class SubscriptionCallback implements Runnable {
     ...
     * <p>
     * Use the {@link app.vbt.hyperupnp.upnp.cling.model.gena.GENASubscription#getCurrentValues()} method to obtain
     ...
     * @param ex                     Call {@link app.vbt.hyperupnp.upnp.cling.model.UnsupportedDataException#getData()} to access the invalid XML.
     */
