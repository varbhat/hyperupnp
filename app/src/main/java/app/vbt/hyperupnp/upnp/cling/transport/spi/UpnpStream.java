 ...
 * {@link app.vbt.hyperupnp.upnp.cling.transport.Router}. See the pseudo-code example
 * in the documentation of {@link StreamServer}. An implementation's
 * <code>run()</code> method has to call the {@link #process(app.vbt.hyperupnp.upnp.cling.model.message.StreamRequestMessage)},
 * {@link #responseSent(app.vbt.hyperupnp.upnp.cling.model.message.StreamResponseMessage)} and
