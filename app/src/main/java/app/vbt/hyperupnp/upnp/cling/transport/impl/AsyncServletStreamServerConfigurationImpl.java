...
import app.vbt.hyperupnp.upnp.cling.transport.spi.ServletContainerAdapter;
import app.vbt.hyperupnp.upnp.cling.transport.spi.StreamServerConfiguration;

/**
 * Settings for the async Servlet 3.0 implementation.
 * <p>
 * If you are trying to integrate Cling with an existing/running servlet
 * container, implement {@link app.vbt.hyperupnp.upnp.cling.transport.spi.ServletContainerAdapter}.
 * </p>
 *
...
public class AsyncServletStreamServerConfigurationImpl implements StreamServerConfiguration {
    ...
    /**
     * The time in seconds this server wait for the {@link app.vbt.hyperupnp.upnp.cling.transport.Router}
     * to execute a {@link app.vbt.hyperupnp.upnp.cling.transport.spi.UpnpStream}.
     *
