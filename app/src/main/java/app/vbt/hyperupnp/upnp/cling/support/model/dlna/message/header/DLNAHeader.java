 ...
 * <p>
 * The {@link #newInstance(app.vbt.hyperupnp.upnp.cling.support.model.dlna.message.header.DLNAHeader.Type, String)} method
...
public abstract class DLNAHeader<T> extends UpnpHeader<T> {
     ...
     * If no {@link app.vbt.hyperupnp.upnp.cling.model.message.header.InvalidHeaderException} is thrown, the subtype
