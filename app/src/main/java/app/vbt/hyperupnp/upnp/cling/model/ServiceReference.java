...
/**
 * Combines a {@link app.vbt.hyperupnp.upnp.cling.model.types.UDN} and a {@link app.vbt.hyperupnp.upnp.cling.model.types.ServiceId}.
 * <p>
 * A service reference is useful to remember a service. For example, if a control point has accessed
 * a service once, it can remember the service with {@link app.vbt.hyperupnp.upnp.cling.model.meta.Service#getReference()}.
 * Before every action invocation, it can now resolve the reference to an actually registered service with
 * {@link app.vbt.hyperupnp.upnp.cling.registry.Registry#getService(ServiceReference)}. If the registry doesn't return
