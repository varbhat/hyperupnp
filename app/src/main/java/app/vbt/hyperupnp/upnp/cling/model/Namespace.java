 ...
 * }</pre>
 * <p>
 * The namespace is also used to discover and create all {@link app.vbt.hyperupnp.upnp.cling.model.resource.Resource}s
 * given a {@link app.vbt.hyperupnp.upnp.cling.model.meta.Device}'s metadata. This procedure is typically
 * invoked once, when the device is added to the {@link app.vbt.hyperupnp.upnp.cling.registry.Registry}.
 * </p>
 *
