...
import app.vbt.hyperupnp.upnp.cling.binding.xml.DescriptorBindingException;
...
public class ReceivingRetrieval extends ReceivingSync<StreamRequestMessage, StreamResponseMessage> {
    ...
    /**
     * Called if the {@link app.vbt.hyperupnp.upnp.cling.registry.Registry} had no result.
     *
