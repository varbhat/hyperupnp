 ...
 * Its constructor may throw {@link app.vbt.hyperupnp.upnp.cling.transport.spi.InitializationException}.
 * </p>
 *
...
public interface StreamClient<C extends StreamClientConfiguration> {
     ...
     * {@link app.vbt.hyperupnp.upnp.cling.model.message.StreamRequestMessage} does not contain such a header.
     * </p>
     * <p>
