 ...
 * or multicast destination. Any {@link app.vbt.hyperupnp.upnp.cling.model.message.OutgoingDatagramMessage} can
 * be converted and written into a datagram with the {@link app.vbt.hyperupnp.upnp.cling.transport.spi.DatagramProcessor}.
 * </p>
 * <p>
...
public interface DatagramIO<C extends DatagramIOConfiguration> extends Runnable {
    ...
    /**
     * Sends a datagram after conversion with {@link app.vbt.hyperupnp.upnp.cling.transport.spi.DatagramProcessor#write(app.vbt.hyperupnp.upnp.cling.model.message.OutgoingDatagramMessage)}.
     *
