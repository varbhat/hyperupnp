...
public interface NetworkAddressFactory {
    ...
    String SYSTEM_PROPERTY_NET_IFACES = "app.vbt.hyperupnp.upnp.cling.network.useInterfaces";
    String SYSTEM_PROPERTY_NET_ADDRESSES = "app.vbt.hyperupnp.upnp.cling.network.useAddresses";
