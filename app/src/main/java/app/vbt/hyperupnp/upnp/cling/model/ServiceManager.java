...
package app.vbt.hyperupnp.upnp.cling.model;
 ...
 * this manager, available with {@link app.vbt.hyperupnp.upnp.cling.model.meta.LocalService#getManager()}:
 * </p>
 * <ul>
 * <li>
 * The {@link app.vbt.hyperupnp.upnp.cling.model.action.ActionExecutor}s use the manager to process
 ...
 * that satisfies the requirements. The {@link app.vbt.hyperupnp.upnp.cling.model.action.ActionExecutor}
 * works together with the manager, for example, the
 * {@link app.vbt.hyperupnp.upnp.cling.model.action.MethodActionExecutor} expects that an action
 ...
 * the {@link app.vbt.hyperupnp.upnp.cling.model.DefaultServiceManager}. A different service manager
 * might require a different set of action executors, and vice versa.
 * </li>
 * <li>
 * The {@link app.vbt.hyperupnp.upnp.cling.model.state.StateVariableAccessor}s use the manager
 ...
 * {@link app.vbt.hyperupnp.upnp.cling.model.state.StateVariableAccessor} works together with
 * the service manager, for example, the {@link app.vbt.hyperupnp.upnp.cling.model.state.FieldStateVariableAccessor}
 ...
 * {@link app.vbt.hyperupnp.upnp.cling.model.DefaultServiceManager}. A different service manager
 ...
 *            bound {@link app.vbt.hyperupnp.upnp.cling.model.action.ActionExecutor}s
 *            and {@link app.vbt.hyperupnp.upnp.cling.model.state.StateVariableAccessor}s.
...
public interface ServiceManager<T> {
     ...
     * <p>
     * The service manager will execute the given {@link app.vbt.hyperupnp.upnp.cling.model.Command} and it
     ...
     * @throws Exception Any exception, without wrapping, as thrown by {@link app.vbt.hyperupnp.upnp.cling.model.Command#execute(ServiceManager)}
     */
     ...
     * <li>The "new value" is a <code>Collection</code> of {@link app.vbt.hyperupnp.upnp.cling.model.state.StateVariableValue},
     ...
     *
     * @return A <code>Collection</code> of {@link app.vbt.hyperupnp.upnp.cling.model.state.StateVariableValue}, representing
