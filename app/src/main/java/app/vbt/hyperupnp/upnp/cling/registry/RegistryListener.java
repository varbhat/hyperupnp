...
public interface RegistryListener {
     ...
     * will be retrieved and parsed. The given {@link app.vbt.hyperupnp.upnp.cling.model.meta.RemoteDevice} metadata
     * is validated and partial {@link app.vbt.hyperupnp.upnp.cling.model.meta.Service} metadata is available. The
     ...
     * <p>
     * If you override the {@link #remoteDeviceDiscoveryStarted(Registry, app.vbt.hyperupnp.upnp.cling.model.meta.RemoteDevice)}
    ...
    /**
     * Called after you add your own device to the {@link app.vbt.hyperupnp.upnp.cling.registry.Registry}.
     *
     * @param registry The Cling registry of all devices and services know to the local UPnP stack.
     * @param device   The local device added to the {@link app.vbt.hyperupnp.upnp.cling.registry.Registry}.
     */
    void localDeviceAdded(Registry registry, LocalDevice device);

    /**
     * Called after you remove your own device from the {@link app.vbt.hyperupnp.upnp.cling.registry.Registry}.
     * <p>
     * This method will not be called when the UPnP stack is shutting down.
     * </p>
     *
     * @param registry The Cling registry of all devices and services know to the local UPnP stack.
     * @param device   The local device removed from the {@link app.vbt.hyperupnp.upnp.cling.registry.Registry}.
     */
