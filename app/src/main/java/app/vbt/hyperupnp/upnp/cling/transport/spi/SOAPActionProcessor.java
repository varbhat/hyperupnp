...
import app.vbt.hyperupnp.upnp.cling.model.message.control.ActionRequestMessage;
import app.vbt.hyperupnp.upnp.cling.model.message.control.ActionResponseMessage;

/**
 * Converts UPnP SOAP messages from/to action invocations.
 * <p>
 * The UPnP protocol layer processes local and remote {@link app.vbt.hyperupnp.upnp.cling.model.action.ActionInvocation}
 * instances. The UPnP transport layer accepts and returns {@link app.vbt.hyperupnp.upnp.cling.model.message.StreamRequestMessage}s
 * and {@link app.vbt.hyperupnp.upnp.cling.model.message.StreamResponseMessage}s. This processor is an adapter between the
