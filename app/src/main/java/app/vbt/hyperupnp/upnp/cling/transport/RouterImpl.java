...
import app.vbt.hyperupnp.upnp.cling.protocol.ProtocolCreationException;
...
import app.vbt.hyperupnp.upnp.cling.transport.spi.NoNetworkException;
...
public class RouterImpl implements Router {
    ...
    /**
     * Initializes listening services: First an instance of {@link app.vbt.hyperupnp.upnp.cling.transport.spi.MulticastReceiver}
     * is bound to each network interface. Then an instance of {@link app.vbt.hyperupnp.upnp.cling.transport.spi.DatagramIO} and
     * {@link app.vbt.hyperupnp.upnp.cling.transport.spi.StreamServer} is bound to each bind address returned by the network
     * address factory, respectively. There is only one instance of
     * {@link app.vbt.hyperupnp.upnp.cling.transport.spi.StreamClient} created and managed by this router.
     */
    @Override
     ...
     * by the {@link app.vbt.hyperupnp.upnp.cling.protocol.ProtocolFactory} for the given message.
     * <p>
     ...
     * {@link app.vbt.hyperupnp.upnp.cling.transport.spi.UpnpStream} directly.
     *
     * @param stream The received {@link app.vbt.hyperupnp.upnp.cling.transport.spi.UpnpStream}.
     */
    ...
    /**
     * Sends the UDP datagram on all bound {@link app.vbt.hyperupnp.upnp.cling.transport.spi.DatagramIO}s.
     *
    ...
    /**
     * Sends the TCP stream request with the {@link app.vbt.hyperupnp.upnp.cling.transport.spi.StreamClient}.
     *
     * @param msg The TCP (HTTP) stream message to send.
     * @return The return value of the {@link app.vbt.hyperupnp.upnp.cling.transport.spi.StreamClient#sendRequest(StreamRequestMessage)}
    ...
    /**
     * Sends the given bytes as a broadcast on all bound {@link app.vbt.hyperupnp.upnp.cling.transport.spi.DatagramIO}s,
     * using source port 9.
     * <p>
