...
package app.vbt.hyperupnp.upnp.cling.model.profile;

import java.net.InetAddress;

import app.vbt.hyperupnp.upnp.cling.model.message.Connection;
...
import app.vbt.hyperupnp.upnp.cling.model.message.header.UserAgentHeader;
import app.vbt.hyperupnp.upnp.seamless.http.RequestInfo;
...
public class RemoteClientInfo extends ClientInfo {
     ...
     * the {@link app.vbt.hyperupnp.upnp.cling.transport.spi.StreamServer} will send meaningless heartbeat
