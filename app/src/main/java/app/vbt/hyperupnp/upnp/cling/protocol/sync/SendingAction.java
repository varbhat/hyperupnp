...
import app.vbt.hyperupnp.upnp.cling.model.message.control.IncomingActionResponseMessage;
import app.vbt.hyperupnp.upnp.cling.model.message.control.OutgoingActionRequestMessage;
...
/**
 * Sending control message, transforming a local {@link app.vbt.hyperupnp.upnp.cling.model.action.ActionInvocation}.
 * <p>
 * Writes the outgoing message's body with the {@link app.vbt.hyperupnp.upnp.cling.transport.spi.SOAPActionProcessor}.
 ...
 * return an {@link app.vbt.hyperupnp.upnp.cling.model.message.control.IncomingActionResponseMessage}. Any error
 * details of a failed response ({@link app.vbt.hyperupnp.upnp.cling.model.message.UpnpResponse#isFailed()}) are
 * available with
 * {@link app.vbt.hyperupnp.upnp.cling.model.action.ActionInvocation#setFailure(app.vbt.hyperupnp.upnp.cling.model.action.ActionException)}.
 * </p>
 *
