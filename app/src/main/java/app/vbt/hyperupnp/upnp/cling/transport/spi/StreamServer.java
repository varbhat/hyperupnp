 ...
 * </p>
 * <p>
 * The {@link UpnpStream} then creates a {@link app.vbt.hyperupnp.upnp.cling.model.message.StreamRequestMessage}
 * and calls the {@link UpnpStream#process(app.vbt.hyperupnp.upnp.cling.model.message.StreamRequestMessage)}
...
public interface StreamServer<C extends StreamServerConfiguration> extends Runnable {
     ...
     * @param router      The router which handles the incoming {@link app.vbt.hyperupnp.upnp.cling.transport.spi.UpnpStream}.
     ...
     * {@link #init(java.net.InetAddress, app.vbt.hyperupnp.upnp.cling.transport.Router)}, the
