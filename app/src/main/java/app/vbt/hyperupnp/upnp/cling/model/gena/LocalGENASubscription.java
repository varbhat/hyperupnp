...
import app.vbt.hyperupnp.upnp.cling.model.ServiceManager;
import app.vbt.hyperupnp.upnp.cling.model.UserConstants;
 ...
 * <p>
 * Uses the {@link app.vbt.hyperupnp.upnp.cling.model.ServiceManager} to read the initial state of
 * the {@link app.vbt.hyperupnp.upnp.cling.model.meta.LocalService} on instantation. Typically, the
 * {@link #registerOnService()} method is called next, and from this point forward all
 * {@link app.vbt.hyperupnp.upnp.cling.model.ServiceManager#EVENTED_STATE_VARIABLES} property change
...
public abstract class LocalGENASubscription extends GENASubscription<LocalService> implements PropertyChangeListener {
    ...
    /**
     * Adds a property change listener on the {@link app.vbt.hyperupnp.upnp.cling.model.ServiceManager}.
     */
    ...
    /**
     * Removes a property change listener on the {@link app.vbt.hyperupnp.upnp.cling.model.ServiceManager}.
     */
    ...
    /**
     * Moderates {@link app.vbt.hyperupnp.upnp.cling.model.ServiceManager#EVENTED_STATE_VARIABLES} events and state variable
