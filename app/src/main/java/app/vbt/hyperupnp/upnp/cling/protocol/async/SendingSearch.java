...
import app.vbt.hyperupnp.upnp.cling.model.message.discovery.OutgoingSearchRequest;
...
public class SendingSearch extends SendingAsync {
    ...
    /**
     * Defaults to {@link app.vbt.hyperupnp.upnp.cling.model.message.header.STAllHeader} and an MX of 3 seconds.
     */
