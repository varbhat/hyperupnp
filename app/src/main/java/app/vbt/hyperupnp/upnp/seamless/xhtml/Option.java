  ...
  */
 package app.vbt.hyperupnp.upnp.seamless.xhtml;
 ...
 public class Option {
     ...
     public boolean isTrue() {
         return getValues().length == 1 && getValues()[0].equalsIgnoreCase("true");
     }

     public boolean isFalse() {
         return getValues().length == 1 && getValues()[0].equalsIgnoreCase("false");
     }
