...
package app.vbt.hyperupnp.upnp.cling.support.avtransport.lastchange;
...
import app.vbt.hyperupnp.upnp.cling.support.lastchange.EventedValueEnum;
import app.vbt.hyperupnp.upnp.cling.support.lastchange.EventedValueEnumArray;
import app.vbt.hyperupnp.upnp.cling.support.lastchange.EventedValueString;
import app.vbt.hyperupnp.upnp.cling.support.lastchange.EventedValueURI;
import app.vbt.hyperupnp.upnp.cling.support.lastchange.EventedValueUnsignedIntegerFourBytes;
import app.vbt.hyperupnp.upnp.cling.support.model.PlayMode;
import app.vbt.hyperupnp.upnp.cling.support.model.RecordQualityMode;
import app.vbt.hyperupnp.upnp.cling.support.model.StorageMedium;
...
public class AVTransportVariable {
    ...
    public static class TransportState extends EventedValueEnum<app.vbt.hyperupnp.upnp.cling.support.model.TransportState> {
        public TransportState(app.vbt.hyperupnp.upnp.cling.support.model.TransportState avTransportState) {
        ...
        @Override
        protected app.vbt.hyperupnp.upnp.cling.support.model.TransportState enumValueOf(String s) {
            return app.vbt.hyperupnp.upnp.cling.support.model.TransportState.valueOf(s);
        }
    }

    public static class TransportStatus extends EventedValueEnum<app.vbt.hyperupnp.upnp.cling.support.model.TransportStatus> {
        public TransportStatus(app.vbt.hyperupnp.upnp.cling.support.model.TransportStatus transportStatus) {
        ...
        @Override
        protected app.vbt.hyperupnp.upnp.cling.support.model.TransportStatus enumValueOf(String s) {
            return app.vbt.hyperupnp.upnp.cling.support.model.TransportStatus.valueOf(s);
        }
    }
    ...
    public static class RecordMediumWriteStatus extends EventedValueEnum<app.vbt.hyperupnp.upnp.cling.support.model.RecordMediumWriteStatus> {
        public RecordMediumWriteStatus(app.vbt.hyperupnp.upnp.cling.support.model.RecordMediumWriteStatus recordMediumWriteStatus) {
        ...
        @Override
        protected app.vbt.hyperupnp.upnp.cling.support.model.RecordMediumWriteStatus enumValueOf(String s) {
            return app.vbt.hyperupnp.upnp.cling.support.model.RecordMediumWriteStatus.valueOf(s);
        }
    }
