...
import static app.vbt.hyperupnp.upnp.cling.model.XMLUtil.appendNewElement;
import static app.vbt.hyperupnp.upnp.cling.model.XMLUtil.appendNewElementIfNotNull;
...
import app.vbt.hyperupnp.upnp.cling.support.model.DIDLAttribute;
...
import app.vbt.hyperupnp.upnp.cling.support.model.Person;
import app.vbt.hyperupnp.upnp.cling.support.model.PersonWithRole;
...
import app.vbt.hyperupnp.upnp.seamless.xml.SAXParser;
 ...
 * </p>
 * <p>
 * Override the {@link #createDescMetaHandler(app.vbt.hyperupnp.upnp.cling.support.model.DescMeta, app.vbt.hyperupnp.upnp.seamless.xml.SAXParser.Handler)}
 * method to read vendor extension content of {@code <desc>} elements. You then should also override the
 * {@link #populateDescMetadata(org.w3c.dom.Element, app.vbt.hyperupnp.upnp.cling.support.model.DescMeta)} method for writing.
 * </p>
 * <p>
 * Override the {@link #createItemHandler(app.vbt.hyperupnp.upnp.cling.support.model.item.Item, app.vbt.hyperupnp.upnp.seamless.xml.SAXParser.Handler)}
...
public class DIDLParser extends SAXParser {
     ...
     * {@link #createDescMetaHandler(app.vbt.hyperupnp.upnp.cling.support.model.DescMeta, app.vbt.hyperupnp.upnp.seamless.xml.SAXParser.Handler)},
     ...
     * {@link app.vbt.hyperupnp.upnp.cling.support.model.DIDLContent#DESC_WRAPPER_NAMESPACE_URI}.
     * </p>
     */
