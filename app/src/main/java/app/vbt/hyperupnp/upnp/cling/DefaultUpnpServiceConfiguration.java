...
import app.vbt.hyperupnp.upnp.cling.binding.xml.UDA10DeviceDescriptorBinderImpl;
import app.vbt.hyperupnp.upnp.cling.binding.xml.UDA10ServiceDescriptorBinderImpl;
...
import app.vbt.hyperupnp.upnp.cling.transport.impl.DatagramIOConfigurationImpl;
import app.vbt.hyperupnp.upnp.cling.transport.impl.DatagramIOImpl;
import app.vbt.hyperupnp.upnp.cling.transport.impl.DatagramProcessorImpl;
import app.vbt.hyperupnp.upnp.cling.transport.impl.GENAEventProcessorImpl;
import app.vbt.hyperupnp.upnp.cling.transport.impl.MulticastReceiverConfigurationImpl;
import app.vbt.hyperupnp.upnp.cling.transport.impl.MulticastReceiverImpl;
import app.vbt.hyperupnp.upnp.cling.transport.impl.NetworkAddressFactoryImpl;
import app.vbt.hyperupnp.upnp.cling.transport.impl.SOAPActionProcessorImpl;
 ...
 * {@link app.vbt.hyperupnp.upnp.cling.transport.impl}.
 * </p>
 * <p>
 * This configuration utilizes the DOM default descriptor binders found in
 * {@link app.vbt.hyperupnp.upnp.cling.binding.xml}.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * The default {@link app.vbt.hyperupnp.upnp.cling.model.Namespace} is configured without any
 * base path or prefix.
 * </p>
 *
...
public class DefaultUpnpServiceConfiguration implements UpnpServiceConfiguration {
    ...
    protected DefaultUpnpServiceConfiguration(int streamListenPort, boolean checkRuntime) {
        if (checkRuntime && ModelUtil.ANDROID_RUNTIME) {
            throw new Error("Unsupported runtime environment, use app.vbt.hyperupnp.android.AndroidUpnpServiceConfiguration");
        }
